# Persistant Version
 ...
 I have some past programming experience but knew 0 about javascript, so this was a fun little side project of learning js and trying to customize it to my liking. It is stitched together with hopes and dreams and a lot of spaghetti, so whatever bugs the original had, you may experience even more. I did try to make it fool-proof (for a fool such as myself) but your mileage may vary.
